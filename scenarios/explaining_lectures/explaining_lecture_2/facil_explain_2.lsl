...
string d1_msg1 = "You are to explain a complex for a first year concept of top-down processing of information. If it comes first - like a formula, it happens first. Computer doesn't get back to this formula after an input has been made by the user, so the user needs to ensure certain operations, like an input, happen first. Use C++ for your examples. You have 2 minutes to prepare.";
...
string d2_msg1 = "Not all the complex concepts can be explained as is or even drawn but creating a concept map that shows interrelations between parts of the concept might be helpful. You might want to try creating such a map.";
list   d2_button1 = ["Okay"];
string d2_msg2 = "Empty";
list   d2_button2 = ["Okay"];

string dw2_msg1 = "You might want to try creating a concept map.";
list   dw2_button1 = ["Okay"];
string dw2_msg2 = "null";
list   dw2_button2 = ["Okay"];

string d3_msg1 = "One of the ways to explain a complex concept is to start with explaining subcomponents or parts of the concept. Alternatively, you could explain all the new terminology and definitions if students don't know them. Then, when parts are explained you could proceed with explaining the whole concept in all its complexity";
list   d3_button1 = ["Okay"];
string d3_msg2 = "Empty";
list   d3_button2 = ["Okay"];

string dw3_msg1 = "You might want to exaplain parts first and then the whole concept";
list   dw3_button1 = ["Okay"];
string dw3_msg2 = "null";
list   dw3_button2 = ["Okay"];

string d4_msg1 = "There are a few ways to promote deep conceptual understanding of the learning material: explaining parts and then the whole is one of them, the other method is explaining using examples, cases or case studies. Please, describe your example now.";
list   d4_button1 = ["Okay"];
string d4_msg2 = "Empty";
list   d4_button2 = ["Okay"];

string dw4_msg1 = "Explaining using examples, cases or case studies is another way to promote deep conceptual understanding of the learning material. Please describe your example now.";
...
string dw5_msg1 = "It's important you link the example to the lecture content";
