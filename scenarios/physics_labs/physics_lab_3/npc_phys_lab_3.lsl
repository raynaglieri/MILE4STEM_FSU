...
0, 1, "I'm trying to set up Capstone and I see a sensor ID on a screen but i am not sure how to link it to a sensor.", 0, 1, "", 1, "sound_hold", 1, "", "",
1, 17, 31,
0, 0, 0, 0, 1, "", 0, 1, "", 1, "", 1, "", "", 
0];
list I_default_A1 = [1, 3, 31,
0, 1, "I am not sure how to properly set the graph in Capstone. I set up y-axis as Force, N, is it all?", 0, 1, "", 1, "sound_hold", 1, "", "",
1, 17, 31,
0, 0, 0, 0, 1, "", 0, 1, "", 1, "", 1, "", "", 
0];
list I_default_A2 = [1, 3, 31,
0, 1, "When I hang mass1 back on force sensor the force value is showing as negative. And yes, I clicked on 'Zero Sensor Now' button before hagning it back. What's wrong?", 0, 1, "", 1, "sound_hold", 1, "", "",
1, 17, 31,
0, 0, 0, 0, 1, "", 0, 1, "", 1, "", 1, "", "", 
0];
list I_default_A3 = [1, 3, 31,
0, 1, "I have completed my measurments and my mean value of the force is 9.67. Is it correct?", 0, 1, "", 1, "sound_hold", 1, "", "",
1, 17, 31,
0, 0, 0, 0, 1, "", 0, 1, "", 1, "", 1, "", "", 
0];
list I_default_A4 = [1, 3, 31,
0, 1, "I am comparing tension or T1 and T2 and I can't get a reading on T2. What's wrong?", 0, 1, "", 1, "sound_hold", 1, "", "",
1, 17, 31,
0, 0, 0, 0, 1, "", 0, 1, "", 1, "", 1, "", "", 
0];
list I_default_A5 = [1, 3, 31,
0, 1, "I am comparing T1 and T2 using one sensor and using two sensors and results are not the same. What's wrong?", 0, 1, "", 1, "sound_hold", 1, "", "",
1, 17, 31,
0, 0, 0, 0, 1, "", 0, 1, "", 1, "", 1, "", "", 
0];
...
0, 1, "Yes, I failed to click on it.", 0, 1, "", 1, "", 1, "", "", 
0];
list I_default_A8 = [1, 3, 15,
0, 2, "Yes", "Yes, I've done it.", 0, 1, "", 1, "", 1, "", "", 
0];
list I_default_A9 = [1, 3, 14,
0, 1, "Yes, I didn't set up a sample rate.", 0, 1, "", 1, "", 1, "", "", 
0];
...
run_routine(string s)
{
  ...
  else if (llList2String(routine_info, 0) == "question")
  {
    ...
    if(llList2String(routine_info, 1) == "comment0")
    {
        ...
        QC_spec = ["I am comparing tension or T1 and T2 and I can't get a reading on T2. What's wrong?", "Did you activate a second sensor?"];
