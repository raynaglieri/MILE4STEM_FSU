//
// LSL script created from an NPCDL file at Mon Oct 29 12:37:40 EDT 2018
//
...
0, 1, "Can you say it again? Why did you do that at the beginning?", 0, 1, "", 1, "", 1, "", "",
1, 17, 35,
0, 0, 0, 0, 5, "okay", "fine", "sounds good", "alright", "thanks", 0, 1, "", 1, "", 1, "", "", 
0];
list I_default_A1 = [1, 3, 14,
0, 1, "Could you show me how to do this problem?", 0, 1, "", 1, "", 1, "raisingahand", "", 
0];
list I_default_A2 = [1, 3, 14,
0, 1, "When I did this, I didn't include line 3. Why do you need that?", 0, 1, "", 1, "", 1, "raisingahand", "", 
0];
list I_default_A3 = [1, 3, 14,
0, 1, "Is there anything we can refer to when solving this type of problems?", 0, 1, "", 1, "", 1, "raisingahand", "", 
0];
...
0, 1, "Now I see how to solve this problem. This is really helpful! Thank you.", 0, 1, "", 1, "", 1, "", "", 
0];
list I_default_A9 = [1, 3, 14,
0, 1, "I don't know.", 0, 1, "", 1, "", 1, "", "", 
0];
list I_default_A10 = [1, 3, 14,
0, 1, "I don't understand how strings work.", 0, 1, "", 1, "", 1, "", "", 
0];
list I_default_A11 = [1, 3, 14,
0, 1, "That looks great! Thanks!", 0, 1, "", 1, "", 1, "", "", 
0];
list I_default_A12 = [1, 3, 14,
0, 1, "Wait, I don't think I understand how to use the job aid. Can you explain again?", 0, 1, "", 1, "", 1, "", "", 
0];
list I_default_A13 = [1, 3, 14,
0, 1, "Ok, great", 0, 1, "", 1, "", 1, "", "", 
0];
