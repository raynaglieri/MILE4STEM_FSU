...
0, 1, "I don't understand. Where are the restictions?", 0, 1, "", 1, "", 1, "", "",
1, 17, 35,
...
0, 1, "I thought the solution for Problem 1 is similar to the solution for Problem 2?", 0, 1, "", 1, "", 1, "", "",
1, 17, 35,
0, 0, 0, 0, 5, "okay", "fine", "sounds good", "alright", "thanks", 0, 1, "", 1, "", 1, "", "", 
0];
...
0, 1, "I think problem 1 constitutes a separate type", 0, 1, "", 1, "", 1, "avatar_no_unhappy", "", 
0];
list I_default_A6 = [1, 3, 14,
0, 1, "", 0, 1, "", 1, "", 1, "avatar_nodding", "", 
0];
list I_default_A7 = [1, 3, 15,
0, 2, "Alright", "Gotcha", 0, 1, "", 1, "", 1, "", "", 
0];
list I_default_A8 = [1, 3, 16,
0, 3, "Cool. Now I'll be able to do it", "Alright, it's eaiser than I thought", "Great", 0, 1, "", 1, "", 1, "", "", 
0];
list I_default_A9 = [1, 3, 14,
0, 1, "", 0, 1, "", 1, "", 1, "", "rand_pairing_structure", 
0];
list I_default_A10 = [1, 3, 14,
0, 1, "Hmm...I don't know...I guess...", 0, 1, "", 1, "", 1, "", "", 
0];
list I_default_A11 = [1, 3, 14,
0, 1, "I don't know how to think aloud", 0, 1, "", 1, "", 1, "", "", 
0];
list I_default_A12 = [1, 3, 14,
0, 1, "I'm totally lost, can you tell us how to think aloud?", 0, 1, "", 1, "", 1, "", "", 
0];
list I_default_A13 = [1, 3, 14,
0, 1, "Why was that question important?", 0, 1, "", 1, "", 1, "", "", 
0];
list I_default_A14 = [1, 3, 14,
0, 1, "How does that affect our final grades?", 0, 1, "", 1, "", 1, "", "", 
0];
list I_default_A15 = [1, 3, 14,
0, 1, "Is there a reason to doubt we know it?", 0, 1, "", 1, "", 1, "", "", 
0];

list I_default_A16 = [1, 3, 14,
0, 1, "", 0, 1, "", 1, "", 1, "avatar_yes_happy", "", 
0];

list I_default_A17 = [1, 3, 14,
0, 1, "", 0, 1, "", 1, "", 1, "", "repeat_animation", 
0];

list I_default_A18 = [1, 3, 14,
0, 1, "me too.", 0, 1, "", 1, "", 1, "avatar_no_unhappy", "", 
0];
...
rand_pairing_structure()
{
    list group_options  = ["1","2","3","4","5","6"];
    list active_group  = group_options;

    integer rand_index = random_integer(0,5);
    string choice_a = llList2String(active_group, rand_index);
    active_group = llDeleteSubList(active_group, rand_index, rand_index);
    string choice_b = llList2String(active_group, random_integer(0,4));
    string rand_pair_sent = "I think " + choice_a + " goes with " + choice_b;
    osNpcSay(npc, rand_pair_sent);
}
...
run_routine(string s)
{
  ...
  else if (s == "rand_pairing_structure") rand_pairing_structure();
  else if (s == "repeat_animation") state AnimationCycle;
...
state AnimationCycle
{
    ...
    {
        osNpcStopAnimation(npc, currentanimation);
        currentanimation = "avatar_nodding";
        osNpcPlayAnimation(npc, currentanimation);
    }
