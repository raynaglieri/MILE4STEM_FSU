//
// LSL script created from an NPCDL file at Wed Sep  5 00:42:50 EDT 2018
//
...
// ^^^^^(3) :- secure_reset(key id). Prevents unauthroized users from de-spawning NPCs.
...
integer scenario_offset = 600000; // ^^^^^^(1) 
...
0, 1, "Can you draw an array?", 0, 1, "", 1, "", 1, "", "",
1, 17, 35,
0, 0, 0, 0, 5, "okay", "fine", "sounds good", "alright", "thanks", 0, 1, "", 1, "", 1, "", "", 
0];
list I_default_A1 = [1, 3, 35,
0, 1, "I thought it will be better with a visualization, but instead I am quite lost. Can you give us an example?", 0, 1, "", 1, "", 1, "", "",
1, 17, 35,
0, 0, 0, 0, 5, "okay", "fine", "sounds good", "alright", "thanks", 0, 1, "", 1, "", 1, "", "", 
0];
...
0, 1, "I think I got a different example from my notes - and at least I understand where the pointers are in this one. Could you repeat again where the pointers are in your example?", 0, 1, "", 1, "", 1, "", "",
1, 17, 35,
0, 0, 0, 0, 5, "okay", "fine", "sounds good", "alright", "thanks", 0, 1, "", 1, "", 1, "", "", 
0];
list I_default_A4 = [1, 3, 35,
0, 1, "Could you use something different, like a physical object or maybe something different on a media board to show where the pointers fit in these two examples.", 0, 1, "", 1, "", 1, "", "",
1, 17, 35,
0, 0, 0, 0, 5, "okay", "fine", "sounds good", "alright", "thanks", 0, 1, "", 1, "", 1, "", "", 
0];
list I_default_A5 = [1, 3, 14,
0, 1, "So you think you can draw me an array", 0, 1, "", 1, "", 1, "", "", 
0];
list I_default_A6 = [1, 3, 14,
0, 1, "Yes, easy, but why don't you ask a TA?", 0, 1, "", 1, "", 1, "", "", 
0];
list I_default_A7 = [1, 3, 14,
0, 1, "Oh, cool. I got it.", 0, 1, "", 1, "", 1, "", "", 
0];
list I_default_A8 = [1, 3, 14,
0, 1, "Oh, I see.", 0, 1, "", 1, "", 1, "", "", 
0];
list I_default_A9 = [1, 3, 14,
0, 1, "Super. I think I understand it now", 0, 1, "", 1, "", 1, "", "", 
0];
list I_default_A10 = [1, 3, 14,
0, 1, ".....", 0, 1, "", 1, "", 1, "", "", 
0];
list I_default_A11 = [1, 3, 14,
0, 1, "", 0, 1, "", 1, "", 1, "conversation1", "", 
0];
list I_default_A12 = [1, 3, 14,
0, 1, "", 0, 1, "", 1, "", 1, "conversation1-f ", "", 
0];
...
default 
{
    ...
    {
        secure_spawn_npc(llDetectedKey(0)); // ^^^^^(6)
    }
...
state Idle_default
{
    ...
    {
        secure_reset(llDetectedKey(0));// ^^^^^^(7) 
    }
