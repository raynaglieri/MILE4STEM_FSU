...
0, 1, "", 0, 1, "", 4, "am_i_doing_everything_correctly_male", "am_i_doing_wrong_female", "extra_time_male", "is_it_correct_male", 1, "", "", 
0];
//helper functions
reset_all() 
{  // resets all globals  
...
state Idle_default
{
	...
	do_ask_action(3);
        register_common_channel_timer(random_integer(15, 30));
    }    
	...
	current_interaction = I_default_T;
	do_ask_action(3);
        llSetTimerEvent(random_integer(15, 30));
    }  
