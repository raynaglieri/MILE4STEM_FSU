...
0, 1, "Excuse me. I don't understand this concept, it is too complex. Besides, I'm a visual learner. Can you visualize it somehow?", 0, 1, "", 1, "", 1, "", "",
1, 17, 35,
0, 0, 0, 0, 5, "okay", "fine", "sounds good", "alright", "thanks", 0, 1, "", 1, "", 1, "", "", 
0];
list I_default_A1 = [1, 3, 35,
0, 1, "I thought it will be better with a concept map, but instead I am quite lost. Why should I put all these Enter things up front?", 0, 1, "", 1, "", 1, "", "",
1, 17, 35,
0, 0, 0, 0, 5, "okay", "fine", "sounds good", "alright", "thanks", 0, 1, "", 1, "", 1, "", "", 
0];
list I_default_A2 = [1, 3, 35,
0, 1, "I don't think it all links up very well and I don't recognize the language", 0, 1, "", 1, "", 1, "", "",
1, 17, 35,
0, 0, 0, 0, 5, "okay", "fine", "sounds good", "alright", "thanks", 0, 1, "", 1, "", 1, "", "", 
0];
list I_default_A3 = [1, 3, 35,
0, 1, "Could you use something different, like a physical object or maybe something different on a media board to show the top-down structures.", 0, 1, "", 1, "", 1, "", "",
1, 17, 35,
0, 0, 0, 0, 5, "okay", "fine", "sounds good", "alright", "thanks", 0, 1, "", 1, "", 1, "", "", 
0];
list I_default_A5 = [1, 3, 14,
0, 1, "Ok. Now I think I get it", 0, 1, "", 1, "", 1, "", "", 
0];
list I_default_A6 = [1, 3, 14,
0, 1, "Now, I'm lost. Can you give us an example?", 0, 1, "", 1, "", 1, "", "", 
0];
list I_default_A7 = [1, 3, 14,
0, 1, "Cool. I think I got it now", 0, 1, "", 1, "", 1, "", "", 
0];
